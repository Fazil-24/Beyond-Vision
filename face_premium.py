...
ap.add_argument("-y", "--yolo", type=str,default="yolov4-mask-detector",help="base path to YOLO directory")
...
ap.add_argument("-u", "--use-gpu", type=bool, default=1,help="boolean indicating if CUDA GPU should be used")
...
vs = cv2.VideoCapture("video/airport.mp4")
writer = None
