...
arg.add_argument('-m', '--model', type=str,default='SSD_MobileNet.caffemodel', help = "Path to the pretrained model.")

arg.add_argument('-p', '--prototxt', type=str,default='SSD_MobileNet_prototxt.txt', help = 'Prototxt of the model.')

arg.add_argument('-l', '--labels', type=str,default='class_labels.txt', help = 'Labels of the dataset.')
...
while cap.isOpened():
    ...
    for i in pos_dict.keys():
        ...
        # Convert cms to feet
        cv2.putText(frame, 'Prob: {i} ft'.format(i=round(pos_dict[i][2]/30.48,4)), (startX, y),
